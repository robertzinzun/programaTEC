...
<head>
  ...
  <!--Bootsrap 4 CDN-->
	...
	<!--Custom styles-->
	<link rel="stylesheet" type="text/css" href="<c:out value="${pageContext.servletContext.contextPath}"/>/css/style.css">
</head>
<body>
<div class="container">
		...
		<div class="card">
			...
			<div class="card-footer">
				<div class="d-flex justify-content-center links">
					Aun no tienes cuenta ? <a href="Alumnos?op=r">Registrarme</a>
				</div>
